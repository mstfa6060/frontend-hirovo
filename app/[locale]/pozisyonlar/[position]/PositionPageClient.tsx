    ...
    <main className="flex-1 py-16">
      <div className="max-w-[1120px] mx-auto px-5">
        ...
        <nav className="mb-8 text-sm">
          ...
          <Link href="/pozisyonlar" className="text-white/60 hover:text-white">Pozisyonlar</Link>
          <span className="mx-2 text-white/40">/</span>
        ...
        <section className="text-center mb-16">
          ...
          <div className="flex flex-wrap justify-center gap-4 mt-6">
            <div className="bg-white/10 backdrop-blur-sm rounded-xl px-6 py-3 border border-white/20">
              <span className="text-white/60 text-sm">Maas Araligi</span>
        ...
        <section className="mb-16">
          <ContentCard>
            <div className="p-4">
              <h2 className="text-2xl font-bold text-text mb-4">{positionData.title} Hakkinda</h2>
        ...
        {/* Skills */}
        <section className="mb-16">
          <h2 className="text-3xl font-bold text-center mb-8">Aranan Beceriler</h2>
        ...
        {/* Experience Levels */}
        <section className="mb-16">
          <h2 className="text-3xl font-bold text-center mb-8">Deneyim Seviyeleri</h2>
        ...
        <section className="text-center">
          <div className="bg-white/10 backdrop-blur-sm rounded-3xl p-12 border border-white/20">
            <h2 className="text-3xl font-bold mb-4">{positionData.title} Ilanlarini Kesfet</h2>
            <p className="text-xl text-white/80 mb-8">Hirovo ile binlerce is firsatina ulas</p>
            <a
              href="https://play.google.com/store/apps/details?id=com.hirovo_mobil_bare"
              target="_blank"
              rel="noopener noreferrer"
