    ...
    <main className="flex-1 py-16">
      <div className="max-w-[1120px] mx-auto px-5">
        ...
        <nav className="mb-8 text-sm">
          ...
          <Link href="/sehirler" className="text-white/60 hover:text-white">Sehirler</Link>
          <span className="mx-2 text-white/40">/</span>
        ...
        <section className="text-center mb-16">
          ...
          <div className="mt-8">
            ...
            >
              ...
              {cityData.name} Is Ilanlarini Gor
            </a>
          </div>
        </section>
        ...
        {/* Highlights */}
        <section className="mb-16">
          <h2 className="text-3xl font-bold text-center mb-8">{cityData.name} Is Pazari Ozellikleri</h2>
        ...
        <section className="text-center">
          <div className="bg-white/10 backdrop-blur-sm rounded-3xl p-12 border border-white/20">
            <h2 className="text-3xl font-bold mb-4">{cityData.name} Is Ilanlarini Kesfet</h2>
            <p className="text-xl text-white/80 mb-8">Hirovo ile {cityData.name} sehrindeki binlerce is firsatina ulas</p>
            <a
              href="https://play.google.com/store/apps/details?id=com.hirovo_mobil_bare"
              target="_blank"
              rel="noopener noreferrer"
