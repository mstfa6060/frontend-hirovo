      ...
      <div className="max-w-[1120px] mx-auto px-5">
        ...
        <section className="text-center py-16">
          ...
          <p className="text-xl text-white/80 mb-10 max-w-2xl mx-auto max-sm:text-lg">
            Hirovo ile binlerce is ilanini kesfet, kolayca basvur ve kariyer firsatlarini takip et.
          </p>
        ...
        <section className="py-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 text-center border border-white/20">
              ...
              <h3 className="text-xl font-semibold mb-3">Kolay Arama</h3>
              <p className="text-white/70">Binlerce is ilani arasinda hizlica arama yap, sana uygun firsatlari bul.</p>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 text-center border border-white/20">
              <div className="w-16 h-16 bg-white/20 rounded-full flex items-center justify-center mx-auto mb-6">
                <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <h3 className="text-xl font-semibold mb-3">Hizli Basvuru</h3>
              <p className="text-white/70">Tek tikla basvur, zaman kaybetme. Profilini bir kez olustur, her yerde kullan.</p>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 text-center border border-white/20">
              <div className="w-16 h-16 bg-white/20 rounded-full flex items-center justify-center mx-auto mb-6">
                <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <h3 className="text-xl font-semibold mb-3">Anlik Bildirimler</h3>
              <p className="text-white/70">Yeni ilanlari ve basvuru durumlarini aninda ogren, firsat kacirma.</p>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 text-center">
          <div className="bg-white/10 backdrop-blur-sm rounded-3xl p-12 border border-white/20 max-sm:p-8">
            <h2 className="text-3xl font-bold mb-4 max-sm:text-2xl">
              Hemen Basla
            </h2>
            <p className="text-xl text-white/80 mb-8 max-sm:text-lg">
              Hirovo&apos;yu indir, hayalindeki ise bir adim daha yaklac.
            </p>
            <a
              href="https://play.google.com/store/apps/details?id=com.hirovo_mobil_bare"
              target="_blank"
