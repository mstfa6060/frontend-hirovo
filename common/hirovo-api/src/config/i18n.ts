...
import backendHirovoEn from '@errors/locales/modules/backend/hirovo/en';
...
// 🌐 Kaynaklar
const resources = {
  tr: { translation: mergeTranslations(uiTr, backendCommonTr, backendHirovoTr) },
  en: { translation: mergeTranslations(uiEn, backendCommonEn, backendHirovoEn) },
