...
const errorsBasePath = path.join(__dirname, '../common/hirovo-api/src/errors/locales/modules/backend');
const errorModules = ['common', 'hirovo'];
...
// ============================
// Translate texts via free Google Translate
// ============================
...
if (command === '--all') {
    ...
    console.log(`
Hirovo - Hata Mesajlari Ceviri Araci
